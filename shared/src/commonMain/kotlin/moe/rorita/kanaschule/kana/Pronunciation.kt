...
object Pronunciation {
    ...
    private val consonants: Map<Row, String?> = mapOf(
        ...
        Row.WA to "w mit locker gerundeten Lippen wie im englischen „water“, " +
            "nicht mit den Zaehnen wie im deutschen „Wasser“.",
        Row.N to null,
        ...
        Row.KYA to "k mit angehaengtem j, in einer Silbe.",
        Row.GYA to "g mit angehaengtem j, in einer Silbe.",
        Row.SHA to "Weiches „sch“ mit angehaengtem j-Klang.",
        Row.JA to "Wie „dsch“ in „Dschungel“.",
        Row.CHA to "Wie „tsch“ in „Tschüss“.",
        Row.NYA to "n mit angehaengtem j, in einer Silbe.",
        Row.HYA to "h mit angehaengtem j, in einer Silbe.",
        Row.BYA to "b mit angehaengtem j, in einer Silbe.",
